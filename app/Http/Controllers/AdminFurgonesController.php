<?php namespace App\Http\Controllers;
	...
	class AdminFurgonesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Capacidad","name"=>"capacidad"];
			...
			$this->form[] = ['label'=>'Capacidad','name'=>'capacidad','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Capacidad","name"=>"capacidad","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			# OLD END FORM
